...
public void completeAction(GButton source, GEvent event) { //_CODE_:completeBtn:927881:
  myPort.write('A');
  showCommands.setText("Resuming Automated Mode");
...
public void createGUI(){
  ...
  autoBtn = new GButton(this, 401, 16, 80, 30);
  autoBtn.setText("Auto Move");
  autoBtn.setTextBold();
  autoBtn.addEventHandler(this, "autoAction");
  completeBtn = new GButton(this, 313, 95, 80, 30);
